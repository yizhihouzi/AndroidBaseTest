 ...
 * from a {@link android.webkit.WebView} which is shown on the screen.
 * <p>
 * This activity shows a simple HTML content in a {@link android.webkit.WebView}
 * and allows the user to print that content via an action in the
 * action bar. The shown {@link android.webkit.WebView} is doing the printing.
 * </p>
 *
